...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2nd Instruction: `If the customer is not known, you must always ask for their email address and their membership number to get their Contact record by running the action 'Get Customer Details' before running any other actions.`                                                                                                                                                                              | `If the customer is not known, call the action 'Get Customer Details by Messaging Session' to retrieve a Salesforce Contact record. If the customer confirms that the authentication is done, retry the action to retrieve the Contact record. Respond with a personalized greeting using the customer name.`                                                                                                        |
